# ![Janice Erhunmwunsee](./banner.svg)
...
## 🔧 Build(ing)
- **[AI Admin Assistant & Legal Platform](your-repo-link)** — Python, LangChain, MySQL, React
- **[Pull](your-repo-link)** — real-time computer-vision hand interaction, React + MediaPipe
- **[Controlled Decay](your-repo-link)** — data dashboard, React + Figma + MySQL
- **[Held Open](your-repo-link)** — generative art exploring decay, p5.js
- **[Product Inventory Management System](your-repo-link)** — Java, Factory pattern, JUnit 5

Open to collaborating on open-source creative-coding tools — [ml5.js](https://github.com/ml5js/ml5-library) is on my list.
